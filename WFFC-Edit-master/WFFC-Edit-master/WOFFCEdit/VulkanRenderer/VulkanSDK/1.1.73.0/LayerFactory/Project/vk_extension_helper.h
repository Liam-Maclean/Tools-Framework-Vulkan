...
struct InstanceExtensions { 
    ...
    uint32_t InitFromInstanceCreateInfo(uint32_t requested_api_version, const VkInstanceCreateInfo *pCreateInfo) {
        ...
        static const std::pair<char const *, bool InstanceExtensions::*> known_extensions[]{
            ...
            {VK_KHR_DEVICE_GROUP_CREATION_EXTENSION_NAME, &InstanceExtensions::vk_khr_device_group_creation},
...
#endif
            {VK_EXT_DEBUG_UTILS_EXTENSION_NAME, &InstanceExtensions::vk_ext_debug_utils},
        };
...
struct DeviceExtensions : public InstanceExtensions { 
    ...
    uint32_t InitFromDeviceCreateInfo(const InstanceExtensions *instance_extensions, uint32_t requested_api_version, const VkDeviceCreateInfo *pCreateInfo) {
        ...
        static const std::pair<char const *, bool DeviceExtensions::*> known_extensions[]{
            ...
            {VK_KHR_MULTIVIEW_EXTENSION_NAME, &DeviceExtensions::vk_khr_multiview},
            {VK_KHR_DEVICE_GROUP_EXTENSION_NAME, &DeviceExtensions::vk_khr_device_group},
            ...
            {VK_KHR_MAINTENANCE3_EXTENSION_NAME, &DeviceExtensions::vk_khr_maintenance3},
...
#ifdef VK_USE_PLATFORM_ANDROID_KHR
            {VK_ANDROID_EXTERNAL_MEMORY_ANDROID_HARDWARE_BUFFER_EXTENSION_NAME, &DeviceExtensions::vk_android_external_memory_android_hardware_buffer},
#endif
            ...
            {VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, &DeviceExtensions::vk_ext_descriptor_indexing},
            ...
            {VK_AMD_SHADER_CORE_PROPERTIES_EXTENSION_NAME, &DeviceExtensions::vk_amd_shader_core_properties},
            {VK_EXT_VERTEX_ATTRIBUTE_DIVISOR_EXTENSION_NAME, &DeviceExtensions::vk_ext_vertex_attribute_divisor},
            {VK_NV_SHADER_SUBGROUP_PARTITIONED_EXTENSION_NAME, &DeviceExtensions::vk_nv_shader_subgroup_partitioned},
        };
        ...
        vk_khr_device_group_creation = instance_extensions->vk_khr_device_group_creation;
        ...
        vk_ext_debug_utils = instance_extensions->vk_ext_debug_utils;
